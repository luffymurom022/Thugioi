...
export async function autoSeedIfEmpty(): Promise<void> {
  ...
  await db.insert(evolutionPathsTable).values([
    { fromSpecies: "Gấu Băng",         toSpecies: "Rồng Băng Lửa",    toRank: "Thần Thú",  toRankLevel: 7, toElement: "Băng Hỏa", toDescription: "Đột phá giới hạn, hợp nhất hai nguyên tố đối lập trong một cơ thể.", minPopulation: 500, minHuntSuccesses: 80,  minAgeTicks: 20 },
    { fromSpecies: "Hổ Lục Lâm",       toSpecies: "Kỳ Lân Lâm",       toRank: "Linh Thú", toRankLevel: 2, toElement: "Mộc",      toDescription: "Hổ rừng thức tỉnh linh tính, mọc sừng kỳ lân, chuyển hóa thành linh thú.", minPopulation: 200, minHuntSuccesses: 100, minAgeTicks: 15 },
    { fromSpecies: "Phượng Hoàng Lửa", toSpecies: "Long Hỏa",          toRank: "Hoàng Thú", toRankLevel: 4, toElement: "Hỏa",      toDescription: "Phượng Hoàng sau ngàn lần tái sinh đột phá thành Hỏa Long thực sự.", minPopulation: 50,  minHuntSuccesses: 150, minAgeTicks: 30 },
    { fromSpecies: "Cá Mập Băng",      toSpecies: "Gấu Băng",          toRank: "Linh Thú", toRankLevel: 2, toElement: "Băng",     toDescription: "Cá mập băng leo lên bờ, thích nghi với đất liền và phát triển thành Gấu Băng.", minPopulation: 700, minHuntSuccesses: 50,  minAgeTicks: 10 },
  ]);
